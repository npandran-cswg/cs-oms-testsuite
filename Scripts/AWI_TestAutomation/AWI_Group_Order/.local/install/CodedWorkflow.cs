...
namespace AWI_TestAutomation.ObjectRepository
{
    public static class Descriptors
    {
        public static class CnS_Cloud_IO
        {
            public static _Implementation._CnS_Cloud_IO.__AWI_common_screen AWI_common_screen { get; private set; } = new _Implementation._CnS_Cloud_IO.__AWI_common_screen();
...
namespace AWI_TestAutomation._Implementation
{
    ...
    namespace _CnS_Cloud_IO._AWI_common_screen
    {
        public class __Item_Code : IElementDescriptor
        {
            ...
            public __Item_Code(IScreenDescriptor screenDescriptor, IElementDescriptor parentElementDescriptor)
            {
                ...
                _elementDescriptor = new ElementDescriptorDefinition{Reference = "D9F-caV3OUejNlJ30AZkgg/yfozAup-FEeB4lQF0et44g", DisplayName = "Item Code", Element = this, ParentElement = _parentElementDescriptor, Screen = screenDescriptor};
            }
        }
    }
    ...
    namespace _CnS_Cloud_IO._AWI_common_screen
    {
        public class __Qty : IElementDescriptor
        {
            ...
            public __Qty(IScreenDescriptor screenDescriptor, IElementDescriptor parentElementDescriptor)
            {
                _screenDescriptor = screenDescriptor;
                _parentElementDescriptor = parentElementDescriptor;
                _elementDescriptor = new ElementDescriptorDefinition{Reference = "D9F-caV3OUejNlJ30AZkgg/L-fl-0uUmk2L1JfOmJiyQQ", DisplayName = "Qty", Element = this, ParentElement = _parentElementDescriptor, Screen = screenDescriptor};
            }
        }
    }
    ...
    {
        public class __AWI_common_screen : IScreenDescriptor
        {
            ...
            public __AWI_common_screen()
            {
                _screenDescriptor = new ScreenDescriptorDefinition{Reference = "D9F-caV3OUejNlJ30AZkgg/a8zlUWheo0C1488tvJiiZw", DisplayName = "AWI common screen", Screen = this};
                Item_Code = new _Implementation._CnS_Cloud_IO._AWI_common_screen.__Item_Code(this, null);
                Qty = new _Implementation._CnS_Cloud_IO._AWI_common_screen.__Qty(this, null);
            }

            public _Implementation._CnS_Cloud_IO._AWI_common_screen.__Item_Code Item_Code { get; private set; }

            public _Implementation._CnS_Cloud_IO._AWI_common_screen.__Qty Qty { get; private set; }
        }
    }
    ...
    {
        public class ___2Popup_Message : IElementDescriptor
        {
            private readonly IScreenDescriptor _screenDescriptor;
            private readonly IElementDescriptor _parentElementDescriptor;
            private readonly IElementDescriptorDefinition _elementDescriptor;
            ...
            public ___2Popup_Message(IScreenDescriptor screenDescriptor, IElementDescriptor parentElementDescriptor)
            {
                _screenDescriptor = screenDescriptor;
                _parentElementDescriptor = parentElementDescriptor;
                _elementDescriptor = new ElementDescriptorDefinition{Reference = "D9F-caV3OUejNlJ30AZkgg/LjaYaYRxZk6QYnAXr8XFnA", DisplayName = "2Popup_Message", Element = this, ParentElement = _parentElementDescriptor, Screen = screenDescriptor};
            }
        }
    }
    ...
    namespace _CnS_Cloud_IO
    {
        public class __Home_Screen : IScreenDescriptor
        {
            ...
            public __Home_Screen()
            {
                ...
                _2Popup_Message = new _Implementation._CnS_Cloud_IO._Home_Screen.___2Popup_Message(this, null);
            ...
            public _Implementation._CnS_Cloud_IO._Home_Screen.___2Popup_Message _2Popup_Message { get; private set; }
